...
import com.marcelphilippe.pontointeligente.api.repositorios.FuncionarioRepository;
...
public class FuncionarioServiceTest {
	...
	public void testBuscarFuncionarioPorCpf() {
		Optional<Funcionario> funcionario = this.funcionarioService.buscarPorCpf("06618938635");
		assertTrue(funcionario.isPresent());
	}
}
